...
PLANIFICACION DE SESION DE CLASE - LECTURA DOMICILIARIA

Libro: {titulo} | Autor: {autor}
Nivel: {nivel} | OA: {oa}
Duracion: 2 horas pedagogicas (45 + 45 = 90 min)
...
PRESENTACION DEL TEXTO (10 min)
Contexto del autor y la obra: {contexto_obra}
Vocabulario clave a trabajar (3 a 5 palabras): {vocabulario_previo}

LECTURA INICIAL / ACTIVIDAD DE ANTICIPACION (25 min)
Tipo de lectura: {tipo_lectura}
Actividad: {actividad_bloque1}
Preguntas guia durante la lectura: {preguntas_durante}
...
CIERRE Y METACOGNICION (20 min)
Actividad de sintesis: {actividad_cierre}
Pregunta de reflexion metacognitiva: {pregunta_metacognitiva}
