...
▸ DISEÑO HACIA ATRÁS (Backward Design)
  ...
  El campo "objective" del JSON: máximo 35 palabras, 1 oración con verbo(s) en infinitivo. PROHIBIDO incluir códigos OA (OA 1, OA 9, OA 21…) ni el texto oficial entre comillas. PROHIBIDO empezar con "El estudiante…" o "El docente…". Solo el objetivo operativo de la sesión.
...
{
  "backward_design": {
    "objective": "SOLO el objetivo operativo: 1 oración con verbo(s) en infinitivo, máximo 35 palabras. PROHIBIDO ABSOLUTO: (a) códigos OA como OA 1, OA 9, OA 21; (b) texto oficial del currículo entre comillas; (c) 'El estudiante...', 'El docente...'. CORRECTO: 'Analizar el conflicto y la voz narrativa del texto para interpretar la relación entre identidad y palabra.' INCORRECTO: 'OA 3: Analizar las narraciones leídas... El docente conducirá...'",
    "assessment_evidence": {
      "producto": "Nombre corto del producto, máximo 6 palabras, sin descripción extensa (ej: 'Ticket de salida OREO individual', 'Texto argumentativo escrito', 'Mapa conceptual en parejas').",
