    ...
    unidades: [
      {
        ...
        temas: [
          {
            id: '7b-u1-1',
            nombre: 'El héroe en distintas épocas',
            oas: [
              ...
              { codigo: 'OA 11', descripcion: 'Aplicar estrategias de comprensión lectora para profundizar la lectura.' },
              { codigo: 'OA 14', descripcion: 'Escribir textos para persuadir (cartas al director, críticas literarias).' },
              { codigo: 'OA 15', descripcion: 'Planificar, escribir, revisar y editar textos en función del contexto y propósito.' },
              { codigo: 'OA 21', descripcion: 'Expresarse en situaciones de comunicación oral formal e informal.' },
            ],
            habilidades: 'Analizar, interpretar, evaluar críticamente, argumentar, planificar textos, dialogar.',
            conceptos_clave: 'Héroe literario y cotidiano, conflicto narrativo, texto argumentativo, interpretación.',
            vocabulario: 'Términos denotativos y connotativos, vocabulario literario, conectores argumentativos.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            id: '7b-u2-1',
            nombre: 'La solidaridad y la amistad',
            oas: [
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre las dimensiones de la experiencia humana a partir de obras literarias.' },
              { codigo: 'OA 3', descripcion: 'Analizar narraciones leídas para enriquecer la comprensión.' },
              { codigo: 'OA 4', descripcion: 'Analizar poemas para enriquecer la comprensión (hablante lírico, lenguaje figurado, recursos sonoros).' },
              { codigo: 'OA 7', descripcion: 'Formular una interpretación de textos literarios.' },
              { codigo: 'OA 10', descripcion: 'Evaluar la credibilidad y pertinencia de fuentes y textos.' },
              ...
              { codigo: 'OA 16', descripcion: 'Escribir creativamente textos literarios.' },
              { codigo: 'OA 21', descripcion: 'Expresarse en situaciones de comunicación oral.' },
            ],
            habilidades: 'Reflexionar, comparar, fundamentar posturas, escribir creativamente, dialogar constructivamente.',
            conceptos_clave: 'Solidaridad, amistad, valores humanos, lenguaje figurado, escritura creativa.',
            vocabulario: 'Conectores de causa-efecto, términos valorativos, registro formal e informal.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            id: '7b-u3-1',
            nombre: 'Mitología y relatos de creación',
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente y desarrollar el gusto por la lectura de diversos textos.' },
              { codigo: 'OA 3', descripcion: 'Analizar narraciones leídas para enriquecer la comprensión.' },
              { codigo: 'OA 6', descripcion: 'Sintetizar información de diversas fuentes para profundizar en un tema.' },
              { codigo: 'OA 7', descripcion: 'Formular una interpretación de textos literarios.' },
              { codigo: 'OA 13', descripcion: 'Escribir artículos informativos con introducción, desarrollo y cierre.' },
              { codigo: 'OA 15', descripcion: 'Planificar, escribir, revisar y editar textos.' },
              { codigo: 'OA 22', descripcion: 'Exponer oralmente información sobre un tema usando vocabulario preciso.' },
              { codigo: 'OA 24', descripcion: 'Seleccionar páginas y fuentes de internet según profundidad y cobertura.' },
              { codigo: 'OA 25', descripcion: 'Investigar sobre un tema siguiendo un proceso de investigación.' },
            ],
            habilidades: 'Investigar, jerarquizar información, parafrasear, sintetizar, exponer oralmente.',
            conceptos_clave: 'Mito, cosmovisión, relato de creación, artículo informativo, fuente confiable.',
            vocabulario: 'Terminología mitológica clásica y originaria, tecnicismos del tema investigado.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            id: '7b-u4-1',
            nombre: 'La identidad: quién soy, cómo me ven los demás',
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente y desarrollar el gusto por la lectura.' },
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre las dimensiones de la experiencia humana.' },
              { codigo: 'OA 3', descripcion: 'Analizar narraciones leídas para enriquecer la comprensión.' },
              { codigo: 'OA 4', descripcion: 'Analizar poemas (hablante lírico, lenguaje figurado, recursos sonoros).' },
              { codigo: 'OA 7', descripcion: 'Formular interpretaciones coherentes de textos literarios.' },
              { codigo: 'OA 13', descripcion: 'Escribir artículos informativos.' },
              { codigo: 'OA 15', descripcion: 'Planificar, escribir, revisar y editar textos.' },
              { codigo: 'OA 18', descripcion: 'Usar correctamente elementos de la lengua para enriquecer la expresión.' },
              { codigo: 'OA 21', descripcion: 'Expresarse en situaciones de comunicación oral.' },
              { codigo: 'OA 23', descripcion: 'Comprender y evaluar textos orales.' },
            ],
            habilidades: 'Autoconocimiento, análisis de personajes, escritura informativa, expresión oral.',
            conceptos_clave: 'Identidad personal, transformación de personajes, imagen social, registro formal vs. informal.',
            vocabulario: 'Términos de identidad y autopercepción, vocabulario descriptivo, palabras complejas.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            id: '7b-u5-1',
            nombre: 'El Romancero y la poesía popular',
            oas: [
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre las dimensiones de la experiencia humana.' },
              { codigo: 'OA 4', descripcion: 'Analizar poemas (hablante lírico, lenguaje figurado, recursos sonoros, métrica).' },
              { codigo: 'OA 5', descripcion: 'Analizar textos dramáticos y sus elementos.' },
              { codigo: 'OA 7', descripcion: 'Formular interpretaciones de textos literarios.' },
              { codigo: 'OA 10', descripcion: 'Evaluar la credibilidad y pertinencia de fuentes.' },
              { codigo: 'OA 14', descripcion: 'Escribir textos para persuadir.' },
              { codigo: 'OA 15', descripcion: 'Planificar, escribir, revisar y editar textos.' },
              { codigo: 'OA 21', descripcion: 'Expresarse en situaciones de comunicación oral.' },
            ],
            habilidades: 'Analizar poesía popular, identificar recursos sonoros, apreciar tradición oral, escribir textos persuasivos.',
            conceptos_clave: 'Romance, poesía popular, tradición oral, métrica, rima, lenguaje figurado.',
            vocabulario: 'Terminología poética (verso, estrofa, rima consonante/asonante), términos del romancero.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            id: '7b-u6-1',
            nombre: 'El terror y lo extraño',
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente y desarrollar el gusto por la lectura.' },
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre las dimensiones de la experiencia humana.' },
              { codigo: 'OA 3', descripcion: 'Analizar narraciones leídas (ambiente, atmósfera, recursos del terror).' },
              { codigo: 'OA 6', descripcion: 'Sintetizar información de diversas fuentes.' },
              { codigo: 'OA 7', descripcion: 'Formular interpretaciones de textos literarios.' },
              { codigo: 'OA 11', descripcion: 'Aplicar estrategias de comprensión para profundizar la lectura.' },
              { codigo: 'OA 14', descripcion: 'Escribir textos para persuadir.' },
              { codigo: 'OA 15', descripcion: 'Planificar, escribir, revisar y editar textos.' },
              { codigo: 'OA 17', descripcion: 'Usar recursos de cohesión para dar coherencia a los textos.' },
              { codigo: 'OA 21', descripcion: 'Expresarse en situaciones de comunicación oral.' },
            ],
            habilidades: 'Analizar atmósferas narrativas, interpretar lo fantástico, escribir cohesionadamente.',
            conceptos_clave: 'Terror literario, lo fantástico, atmósfera, suspenso, recursos narrativos del horror.',
            vocabulario: 'Términos de lo fantástico y sobrenatural, vocabulario de suspenso, conectores de cohesión.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            ...
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente textos de medios de comunicación.' },
              { codigo: 'OA 9', descripcion: 'Evaluar textos de los medios de comunicación masiva.' },
              { codigo: 'OA 10', descripcion: 'Evaluar la credibilidad y pertinencia de fuentes.' },
              { codigo: 'OA 12', descripcion: 'Aplicar estrategias de vocabulario para comprender textos de medios.' },
              { codigo: 'OA 13', descripcion: 'Escribir artículos informativos sobre temas de actualidad.' },
              { codigo: 'OA 18', descripcion: 'Usar correctamente elementos de la lengua.' },
              { codigo: 'OA 19', descripcion: 'Usar correctamente normas de ortografía.' },
              { codigo: 'OA 20', descripcion: 'Dialogar constructivamente para debatir ideas sobre medios.' },
              { codigo: 'OA 22', descripcion: 'Exponer oralmente información sobre temas de los medios.' },
              { codigo: 'OA 23', descripcion: 'Comprender y evaluar textos orales y audiovisuales.' },
              { codigo: 'OA 24', descripcion: 'Seleccionar páginas y fuentes de internet.' },
              { codigo: 'OA 25', descripcion: 'Investigar sobre un tema relacionado con los medios de comunicación.' },
            ],
            habilidades: 'Analizar críticamente medios, evaluar fuentes, investigar, exponer, escribir artículos.',
            conceptos_clave: 'Medios de comunicación, noticia, publicidad, propaganda, confiabilidad de fuentes.',
            vocabulario: 'Terminología periodística, recursos persuasivos, tecnicismos de medios digitales.',
          },
        ],
      },
    ],
        ...
        temas: [
          {
            ...
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente y desarrollar el gusto por la lectura.' },
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre las dimensiones de la experiencia humana a partir de obras literarias.' },
              { codigo: 'OA 3', descripcion: 'Analizar narraciones leídas (conflictos, personajes, disposición temporal).' },
              { codigo: 'OA 6', descripcion: 'Sintetizar y registrar ideas principales de diversas fuentes.' },
              { codigo: 'OA 8', descripcion: 'Analizar y evaluar textos argumentativos.' },
              { codigo: 'OA 11', descripcion: 'Aplicar estrategias de comprensión lectora.' },
              { codigo: 'OA 12', descripcion: 'Aplicar estrategias de vocabulario.' },
              { codigo: 'OA 14', descripcion: 'Escribir textos para persuadir con documentación.' },
              { codigo: 'OA 16', descripcion: 'Escribir creativamente textos literarios.' },
              { codigo: 'OA 22', descripcion: 'Exponer oralmente con vocabulario preciso.' },
            ],
            habilidades: 'Analizar conflictos y personajes, interpretar visiones de mundo, resumir, investigar, planificar textos.',
            conceptos_clave: 'Epopeya, héroe épico, conflicto narrativo, contexto histórico, sentido del deber y honor.',
            vocabulario: 'Recapitulación, anáforas, referencias bibliográficas, términos épicos.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            ...
            oas: [
              ...
              { codigo: 'OA 8', descripcion: 'Analizar y evaluar textos argumentativos.' },
              { codigo: 'OA 23', descripcion: 'Comprender y evaluar textos orales; exponer con orden lógico y criterios de confiabilidad.' },
              { codigo: 'OA 25', descripcion: 'Investigar sobre un tema, siguiendo un proceso de investigación.' },
              { codigo: 'OA 26', descripcion: 'Seleccionar y usar fuentes de información para profundizar en un tema.' },
            ],
            habilidades: 'Analizar poemas amorosos, investigar contextos históricos, exponer oralmente, sintetizar ideas.',
            conceptos_clave: 'Amor cortés, tópico literario, sociedad medieval, lenguaje figurado, confiabilidad de fuentes.',
            vocabulario: 'Muletillas, conectores de organización, categorías de investigación, términos del amor cortés.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            id: '8b-u3-1',
            nombre: 'Relatos de misterio',
            oas: [
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre las dimensiones de la experiencia humana.' },
              { codigo: 'OA 3', descripcion: 'Analizar narraciones (estructura, personajes, suspenso).' },
              { codigo: 'OA 8', descripcion: 'Analizar y evaluar textos argumentativos.' },
              { codigo: 'OA 12', descripcion: 'Aplicar estrategias de vocabulario; identificar pérdida de referentes.' },
              { codigo: 'OA 13', descripcion: 'Escribir textos usando deícticos y elipsis para evitar repeticiones.' },
              { codigo: 'OA 17', descripcion: 'Escribir creativamente crónicas, diarios y relatos de misterio.' },
              { codigo: 'OA 18', descripcion: 'Usar recursos de cohesión para dar coherencia a los textos.' },
              { codigo: 'OA 22', descripcion: 'Exponer oralmente con vocabulario preciso.' },
            ],
            habilidades: 'Analizar creación de suspenso, escribir creativamente, usar oraciones complejas con referentes claros.',
            conceptos_clave: 'Detective, capacidad de observación, correferencia, nominalización, elipsis, suspenso.',
        ...
        temas: [
          {
            ...
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente y desarrollar el gusto por la lectura.' },
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre la vigencia de obras clásicas y contemporáneas.' },
              { codigo: 'OA 3', descripcion: 'Analizar narraciones leídas.' },
              { codigo: 'OA 4', descripcion: 'Analizar poemas (imágenes, comparaciones, lenguaje figurado).' },
              { codigo: 'OA 8', descripcion: 'Evaluar críticamente textos argumentativos y audiovisuales.' },
              { codigo: 'OA 15', descripcion: 'Sustentar posturas con evidencias; adecuar registro al destinatario.' },
              { codigo: 'OA 16', descripcion: 'Escribir creativamente textos literarios (columnas de opinión, poemas).' },
              { codigo: 'OA 19', descripcion: 'Usar correctamente normas de ortografía.' },
              { codigo: 'OA 21', descripcion: 'Expresarse en situaciones de comunicación oral.' },
            ],
            habilidades: 'Interpretar símbolos y alegorías, escribir para persuadir, evaluar textos audiovisuales.',
            conceptos_clave: 'Símbolo, alegoría, naturaleza en la literatura, escritura persuasiva, modos verbales.',
            vocabulario: 'Términos de naturaleza, lenguaje figurado, conectores de persuasión.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            ...
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente y desarrollar el gusto por la lectura.' },
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre rasgos de época en obras dramáticas.' },
              { codigo: 'OA 5', descripcion: 'Analizar textos dramáticos (comedias, conflicto, personajes).' },
              { codigo: 'OA 7', descripcion: 'Formular interpretaciones coherentes de textos literarios.' },
              { codigo: 'OA 8', descripcion: 'Analizar y evaluar textos argumentativos.' },
              { codigo: 'OA 11', descripcion: 'Aplicar estrategias de comprensión lectora.' },
              { codigo: 'OA 14', descripcion: 'Escribir textos informativos organizados.' },
              { codigo: 'OA 16', descripcion: 'Escribir creativamente textos literarios.' },
              { codigo: 'OA 20', descripcion: 'Dialogar constructivamente; debatir en paneles sobre textos leídos.' },
              { codigo: 'OA 22', descripcion: 'Exponer oralmente con vocabulario preciso.' },
            ],
            habilidades: 'Analizar comedias, comprender visiones de mundo, escribir artículos, debatir en panel.',
            conceptos_clave: 'Comedia, conflicto cotidiano, obra dramática vs. representación teatral, debate estructurado.',
            vocabulario: 'Acotaciones, parlamentos, términos técnicos de comedia, recursos del humor.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            id: '8b-u6-1',
            nombre: 'El mundo descabellado',
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente y desarrollar el gusto por la lectura.' },
              { codigo: 'OA 2', descripcion: 'Reflexionar sobre experiencias de personajes distintas a las propias.' },
              { codigo: 'OA 3', descripcion: 'Analizar narraciones de mundos descabellados o absurdos.' },
              { codigo: 'OA 8', descripcion: 'Evaluar críticamente tesis y argumentos.' },
              { codigo: 'OA 9', descripcion: 'Identificar prejuicios y sesgos en textos de medios.' },
              { codigo: 'OA 11', descripcion: 'Aplicar estrategias de comprensión lectora.' },
              { codigo: 'OA 15', descripcion: 'Escribir textos para persuadir; sustentar posturas con evidencias.' },
              { codigo: 'OA 16', descripcion: 'Escribir creativamente textos literarios.' },
              { codigo: 'OA 22', descripcion: 'Exponer oralmente con vocabulario preciso.' },
            ],
            habilidades: 'Analizar mundos descabellados, evaluar tesis y argumentos, escribir creativamente, dialogar.',
            conceptos_clave: 'Mundo descabellado, absurdo, hecho vs. opinión, tesis y razones, ironía literaria.',
            vocabulario: 'Modalizadores de certeza, conectores lógicos, sintaxis académica, términos del absurdo.',
          },
        ],
      },
      {
        ...
        temas: [
          {
            ...
            oas: [
              { codigo: 'OA 1', descripcion: 'Leer habitualmente textos de medios de comunicación.' },
              { codigo: 'OA 9', descripcion: 'Evaluar textos de medios de comunicación masiva (noticias, publicidad).' },
              ...
              { codigo: 'OA 16', descripcion: 'Escribir creativamente textos de opinión.' },
              { codigo: 'OA 21', descripcion: 'Expresarse en situaciones de comunicación oral.' },
              { codigo: 'OA 22', descripcion: 'Exponer oralmente sin muletillas con material visual de apoyo.' },
              { codigo: 'OA 23', descripcion: 'Comprender y evaluar textos orales; identificar propósitos implícitos en noticias.' },
              { codigo: 'OA 24', descripcion: 'Seleccionar páginas y fuentes de internet.' },
              { codigo: 'OA 25', descripcion: 'Investigar sobre un tema de los medios de comunicación.' },
              { codigo: 'OA 26', descripcion: 'Seleccionar y usar fuentes de información para profundizar en un tema.' },
            ],
            habilidades: 'Evaluar críticamente noticieros, investigar temas, expresarse con volumen y dicción, jerarquizar ideas.',
            conceptos_clave: 'Objetividad periodística, sensacionalismo, ética del uso de información, fuente confiable.',
            vocabulario: 'Tematización, conectores de exposición, bibliografía, registro formal, términos periodísticos.',
          },
        ],
      },
    ],
